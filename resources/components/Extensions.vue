...
module.exports = {
    ...
    /* Don't display extensions requiring composer dependencies since composer dependencies installation
    requires explicit write permission from the web-server user on the future extension's directory */
